...
Agent and contributor behaviour should optimise for:

- correctness over surface area
- validated behaviour over assumed behaviour
...
- Treat runtime behaviour as suspect until verified by static analysis, public spec comparison, or live tests.
...
2. Preserve validated behaviour before adding new feature surface.
...
- broad refactors before behaviour is stable
