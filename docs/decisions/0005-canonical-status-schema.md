...
The first canonical platform status artefact will be a tool-keyed machine-readable file at:
...
The single highest-value next step needed to advance the tool towards Full Support.
