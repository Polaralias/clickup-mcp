...
export type ListReferenceLinksResult = {
  summary: string
  links: ReferenceLink[]
  truncated: boolean
  source: string
...
function extractSidebar(html: string) {
...
function parseSectionFromTag(tag: string) {
...
function parseRawLinks(html: string): RawLink[] {
...
function convertToReferenceLink(raw: RawLink): ReferenceLink {
...
export async function listReferenceLinks(input: Input = {}): Promise<ListReferenceLinksResult> {
